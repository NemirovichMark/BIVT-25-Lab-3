...
namespace Lab3
{
    public class Program
    {
        ...
        private static void TestPurple()
        {
            ...
            Console.WriteLine($"Task2 test 1 {Equals(purple.Task2(0), (0, 0))}");
            Console.WriteLine($"Task2 test 2. Paste 4 inputs");
            Console.WriteLine($"Task2 test 2 {Equals(purple.Task2(1), (1, 2.75))}");
            Console.WriteLine($"Task2 test 3. Paste 8 inputs");
            Console.WriteLine($"Task2 test 3 {Equals(purple.Task2(2), (1, 3.75))}");
            Console.WriteLine($"Task2 test 4. Paste 20 inputs");
            Console.WriteLine($"Task2 test 4 {Equals(purple.Task2(5), (2, 4.05))}");
            Console.WriteLine($"Task2 test 5. Paste 40 inputs");
            Console.WriteLine($"Task2 test 5 {Equals(purple.Task2(10), (3, 3.925))}");
            ...
            Console.WriteLine($"Task4 test 1. Insert input until the task completes");
            Console.WriteLine($"Task4 test 1 {Equals(purple.Task4(000, 1), ("Система заблокирована!", 1))}");
            Console.WriteLine($"Task4 test 2. Insert input until the task completes");
            Console.WriteLine($"Task4 test 2 {Equals(purple.Task4(000, 5), ("Аварийный выход!", 4))}");
            Console.WriteLine($"Task4 test 3. Insert input until the task completes");
            Console.WriteLine($"Task4 test 3 {Equals(purple.Task4(123, 3), ("Доступ разрешен!", 2))}");
            Console.WriteLine($"Task4 test 4. Insert input until the task completes");
            Console.WriteLine($"Task4 test 4 {Equals(purple.Task4(283, 3), ("Доступ разрешен!", 3))}");
            Console.WriteLine($"Task4 test 5. Insert input until the task completes");
            Console.WriteLine($"Task4 test 5 {Equals(purple.Task4(283, 2), ("Система заблокирована!", 2))}");
        }
    }
}
